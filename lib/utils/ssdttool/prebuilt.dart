...
''';
  ...
  /// SSDT-PNLF
  static const String ssdtPNLF = r'''// Universal PNLF device based on the OpenCorePkg SSDT-PNLF sample.
// Source: https://github.com/acidanthera/OpenCorePkg/blob/master/Docs/AcpiSamples/Source/SSDT-PNLF.dsl
// Original implementation: RehabMan/OS-X-Clover-Laptop-Config (GNU GPL v2).
DefinitionBlock ("", "SSDT", 2, "RAPID", "PNLF", 0x00000000)
{
    External (_SB.PCI0.GFX0, DeviceObj)
    External (_SB.PCI0.IGPU, DeviceObj)
    External (_SB.PCI0.VID0, DeviceObj)
    ...
    If (_OSI ("Darwin"))
    {
        ...
        Device (XNLF)
        {
            ...
            Method (_INI, 0, NotSerialized)
            {
                ...
                If ((One == Local3) || (Ones != Match (Package ()
                {
                    0x010B, 0x0102, 0x0106, 0x1106, 0x1601,
                    0x0116, 0x0126, 0x0112, 0x0122, 0x0152,
                    0x0156, 0x0162, 0x0166, 0x016A, 0x0046,
                    0x0042
                ...
                ElseIf ((0x03 == Local3) || (Ones != Match (Package ()
                {
                    0x3E9B, 0x3EA5, 0x3E92, 0x3E91, 0x3EA0,
                    0x3EA6, 0x3E98, 0x9BC8, 0x9BC5, 0x9BC4,
                    0xFF05, 0x8A70, 0x8A71, 0x8A51, 0x8A5C,
                    0x8A5D, 0x8A52, 0x8A53, 0x8A56, 0x8A5A,
                    0x8A5B, 0x9B41, 0x9B21, 0x9BCA, 0x9BA4
                }, MEQ, Local0, MTR, Zero, Zero)))
                {
                    If (Ones == Local2)
                    {
                ...
                Else
                {
                    If (Ones == Local2)
                    {
                        ...
                        {
                            0x0D26, 0x0A26, 0x0D22, 0x0412,
                            0x0416, 0x0A16, 0x0A1E, 0x0A1E,
                            0x0A2E, 0x041E, 0x041A, 0x0BD1,
                            0x0BD2, 0x0BD3, 0x1606, 0x160E,
                            0x1616, 0x161E, 0x1626, 0x1622,
                            0x1612, 0x162B
                        }, MEQ, Local0, MTR, Zero, Zero))
                        {
                            Local2 = 0x0AD9
